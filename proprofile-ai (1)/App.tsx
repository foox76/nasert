...
function App() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-100 font-sans print:h-auto print:w-auto print:overflow-visible print:block print:bg-white">
      ...
      <div className="flex-1 h-full relative print:h-auto print:w-full print:block">
        <Preview data={data} />
      </div>
    </div>
  );
